...
function draw() {
  ...
  var poem_one = "drenched in echoes of salty voices // your spirit lies in wake // eclipsed by neon // as your sunshine rusts";
  fill(50);
  text(poem_one, 30, 30, 150, 100);

  var poem_two = "locked in noise // something anchored in your throat // colonizes your voice // your lips crack";
  fill(50);
  text(poem_two, 30, 500, 150, 100);

  var poem_three = "i became the waves // nibbling day and night // at unending rocks // thrown at me";
  fill(50);
  text(poem_three, 1000, 30, 150, 100);

  var poem_four = "streaks of colour // snatched from their home of pink // left to rot at the back of your head // which is a graveyard";
  fill(50);
